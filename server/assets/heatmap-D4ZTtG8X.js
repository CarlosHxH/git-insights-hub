import { f as commonjsGlobal, y as getDefaultExportFromCjs, U as reactExports, R as React, L as jsxRuntimeExports } from "./server-BXNvyGht.js";
import { c as clsx } from "./router-BawXN-e9.js";
var isArray_1;
...
function CommitChart({ dates, days = 30 }) {
  const data = reactExports.useMemo(() => {
    ...
    for (const d of dates) {
      const k2 = new Date(d).toISOString().slice(0, 10);
      if (buckets.has(k2)) buckets.set(k2, (buckets.get(k2) ?? 0) + 1);
    }
    return Array.from(buckets, ([date2, count]) => ({ date: date2.slice(5), count }));
  }, [dates, days]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data, margin: { top: 10, right: 10, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "cm", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.74 0.18 200)", stopOpacity: 0.55 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.74 0.18 200)", stopOpacity: 0 })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "oklch(1 0 0 / 0.06)", vertical: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "date", stroke: "oklch(0.7 0.03 255)", tick: { fontSize: 10 }, tickLine: false, axisLine: false }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.7 0.03 255)", tick: { fontSize: 10 }, tickLine: false, axisLine: false, width: 32 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "count", stroke: "oklch(0.85 0.2 195)", strokeWidth: 2, fill: "url(#cm)" })
  ] }) });
}
function Heatmap({ dates, weeks = 26 }) {
  ...
  const max2 = Math.max(1, ...cells.map((c2) => c2.count));
  const level = (n) => {
    if (n === 0) return 0;
    const r = n / max2;
    if (r < 0.25) return 1;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: cells.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          title: `${c2.date} · ${c2.count} commits`,
          className: "size-3 rounded-[3px] transition-transform hover:scale-110",
          style: { background: palette[level(c2.count)] }
        },
        c2.date
      ))
    }
